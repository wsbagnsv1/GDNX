...
_RECORDS = (
    ...
    _spec("state_size.sweep", "state_size", "state_size_sweep", "addition", "incremental", _TINY, frozenset({"mqar"}), parameters=("q_proj.weight", "k_proj.weight", "v_proj.weight", "conv.weight", "decay_chan", "q_slot_scale", "rot_proj.weight", "rot_proj.bias", "rotation_rate", "out_proj.weight"), state=("state_shape",), stage="mechanism_screen", experiment_kind="cold_redesign", native_warm_start=False),
    _spec("true_mimo.sweep", "true_mimo", "true_mimo_sweep", "addition", "incremental", _TINY, frozenset({"mqar"}), parameters=("q_proj.weight", "k_proj.weight", "v_proj.weight", "b_proj.weight", "conv.weight", "bw_off", "q_slot_scale", "out_mix"), state=("simultaneous_slots",), stage="mechanism_screen", experiment_kind="cold_redesign", native_warm_start=False),
